...
impl BlockTranslator<'_> {
    ...
    pub fn read_sysreg(&mut self, reg: &SysReg) -> Value {
        match reg {
            ...
            SysReg::CNTPCT_EL0 => self.timer_read(timer::RegisterID::CNTPCT_EL0),
            ...
            SysReg::CNTV_TVAL_EL0 => self.timer_read(timer::RegisterID::CNTV_TVAL_EL0),
            ...
            SysReg::ID_AA64ISAR3_EL1 => self.builder.ins().iconst(I64, 0),
            SysReg::MIDR_EL1 => register_field!(read self, id_registers.midr_el1),
            SysReg::MPIDR_EL1 => self.builder.ins().iconst(I64, 0),
            SysReg::MPAM1_EL1 | SysReg::MPAMIDR_EL1 => self.builder.ins().iconst(I64, 0),
            ...
            SysReg::ID_AA64PFR2_EL1 => self.builder.ins().iconst(I64, 0),
            SysReg::ID_AA64FPFR0_EL1 => self.builder.ins().iconst(I64, 0),
            ...
            SysReg::ID_AA64MMFR4_EL1 => register_field!(read self, id_registers.id_aa64mmfr4_el1),
    ...
    pub fn write_sysreg(&mut self, reg: &SysReg, value: Value) {
        ...
        match reg {
            ...
            SysReg::CNTV_TVAL_EL0 => self.timer_write(timer::RegisterID::CNTV_TVAL_EL0, value),
