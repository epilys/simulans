...
use crate::{
    cpu_state::{ArchMode, Exception, ExceptionLevel, SpSel},
    memory::Address,
};
...
pub fn aarch64_take_exception(
    ...
    // PSTATE.<D,A,I,F> = '1111';
    machine.cpu_state.pstate.set_D(true);
    machine.cpu_state.pstate.set_A(true);
    machine.cpu_state.pstate.set_I(true);
    machine.cpu_state.pstate.set_F(true);
